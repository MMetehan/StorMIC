...
> **You need to run your own signaling server.** See [`https://github.com/MMetehan/StorMIC-Backend/README.md`](../https://github.com/MMetehan/StorMIC-Backend/README.md) for setup instructions.
...
StorMIC requires a signaling server to work. The server is a tiny stateless WebSocket relay — no accounts, no storage, no message history. See **[`https://github.com/MMetehan/StorMIC-Backend/README.md`](../https://github.com/MMetehan/StorMIC-Backend/README.md)** for:

- How to run the server locally
- How to deploy to Render.com or Heroku
- The full WebSocket message protocol

Once your server is running, configure the URL in `client/.env` before building (see below), or set it at runtime from the app's Settings panel → Signaling Server URL.
...
> **Kendi sinyal sunucunu çalıştırman gerekir.** Kurulum talimatları için [`https://github.com/MMetehan/StorMIC-Backend/README.md`](../https://github.com/MMetehan/StorMIC-Backend/README.md) dosyasına bak.
...
StorMIC'in çalışması için bir sinyal sunucusu gereklidir. Sunucu; küçük, durumsuz bir WebSocket aktarıcısıdır — hesap yok, depolama yok, mesaj geçmişi yok. Aşağıdakiler için **[`https://github.com/MMetehan/StorMIC-Backend/README.md`](../https://github.com/MMetehan/StorMIC-Backend/README.md)** dosyasına bak:

- Sunucuyu yerel olarak çalıştırma
- Render.com veya Heroku'ya deploy etme
- Tam WebSocket mesaj protokolü

Sunucun hazır olduğunda, build almadan önce URL'yi `client/.env` dosyasında yapılandır (aşağıya bak) veya çalışma zamanında uygulama içindeki Ayarlar paneli → Sinyal Sunucusu URL alanından ayarla.
